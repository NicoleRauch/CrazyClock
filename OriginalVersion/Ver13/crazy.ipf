...
:h1 id=2002  res=2002 .Crazy Clock
:i1 id=2002 .Crazy Clock

:lines align=center.
Crazy Clock
Version 1.3
(C) 1994-96 :link reftype=hd res=2501 .Nicole Greiber:elink.
N&amp.O Design
:p.This program is :link reftype=hd res=2502 .Postcardware:elink.! 
:elines.
:p.
:p.
:hp7.Crazy:ehp7.
...
:link reftype=hd res=2500 .What are these coloured circles good for?:elink.
:p.
Please make sure you don&apos.t miss any of Crazy Clock&apos.s nice
features like :link reftype=hd res=2503 .minimizing to desktop:elink.
or :link reftype=hd res=2101 .MMPM support:elink.!
:p.
...
:li.:link reftype=hd res=2100 .Options Menu:elink.
:li.:link reftype=hd res=2200 .Help Menu:elink.
:li.:link reftype=hd res=2250 .System Menu Additions:elink.
...
:h2 id=2500  res=2500 .What are these coloured circles good for?
:i1 id=2500 .What are these coloured circles good for?
...
:h2 id=2501  res=2501 .About the author
:i1 id=2501 .About the author
...
:link reftype=hd res=2502 .postcard:elink. to)&colon.
.br
:lines align=left.
:lm margin=10.
Nicole Greiber
...
:h2 id=2502  res=2502 .Postcardware - what is it?
:i1 id=2502 .Postcardware - what is it?
:p.
...
:p.
For :link reftype=hd res=2501 .my address:elink.
see :link reftype=hd res=2501 .my address:elink..
:p.
...
:p.
Thanks to everybody who sent me mail or even a postcard. Most of the improvements
...
:h1 id=2503  res=2503 .Minimize to Desktop
:i1 id=2503 .Minimize to Desktop
:p.
...
This is done in the :link reftype=hd res=2250 .system menu:elink..
...
in the :link reftype=hd res=2250 .system menu:elink..
...
:h1 id=2100  res=2100 .Options Menu
:i1 id=2100  sortkey=Options.Options Menu
:p.
...
:dt.:link reftype=hd res=2102 .:hp2.Colors...:ehp2.:elink.

:dt.:link reftype=hd res=2101 .:hp2.Settings...:ehp2.:elink.

:dt.:link reftype=hd res=2103 .:hp2.Alarm...:ehp2.:elink.

:dt.:hp2.Adjust window size:ehp2.
:i2 refid=2100  sortkey=d.Adjust window size
:i1 id=2100 .Adjust window size
:dd.With this menu entry you can shrink the window size so
that it will fit the dots. 

:dt.:hp2.Minimize:ehp2.
:i2 refid=2100  sortkey=e.Minimize
:i1 id=2100 .Minimize
:dd.When you select this menu entry, the program will be 
:link reftype=hd res=2503 .minimized to the desktop:elink..
...
:h2 id=2102  res=2102 .Colors...
:i2 refid=2100  sortkey=a.Colors...
:i1 id=2102 .Colors...
:p.
:dd.A window will be opened where you can choose
...
:h2 id=2101  res=2101 .Settings...
:i2 refid=2100  sortkey=b.Settings...
:i1 id=2101 .Settings...
:p.
:dd.The Settings dialog box contains the following items. You can
check and uncheck them and watch the results immediately.

:dl break=all tsize=3.

:dt.:hp2.Show seconds:ehp2.
:i2 refid=2101  sortkey=a.Show seconds
:i1 id=2101 .Show seconds
...
:i2 refid=2101  sortkey=b.24 hour mode
:i1 id=2101 .24 hour mode
:dd.This check box toggles the representation of the time.

:dt.:hp2.Show title bar:ehp2.
:i2 refid=2101  sortkey=c.Show title bar
:i1 id=2101 .Show title bar
...
:i2 refid=2101  sortkey=d.Read numbers
:i1 id=2101 .Read numbers
...
:link reftype=hd res=2501 .me:elink.! 

:dt.:hp2.Hour chime:ehp2.
:i2 refid=2101  sortkey=e.Hour chime
:i1 id=2101 .Hour chime
:dd.Checking this option will cause Crazy Clock to play a sound
at every full hour. This works only when you have the MMPM portion 
of OS/2 installed.
...
:h2 id=2103  res=2103 .Alarm...
:i2 refid=2100  sortkey=c.Alarm...
:i1 id=2103 .Alarm...
:p.
:dd.Here you can specify an alarm time and what will happen if it&apos.s
...
:i2 refid=2103  sortkey=a.Activate alarm 
:i1 id=2103 .Activate alarm 
:dd.This button&apos.s purpose should be fairly obvious.

:dt.:hp2.Sound:ehp2.
:i2 refid=2103  sortkey=b.Sound
:i1 id=2103 .Sound
...
:i2 refid=2103  sortkey=ba.Sound and window
:i1 id=2103 .Sound and window
:dd.When you check this button, you will also hear an alarm sound.
...
:i2 refid=2103  sortkey=c.Alarm time
:i1 id=2103 .Alarm time
...
:h1 id=2200  res=2200 .Help Menu
:i1 id=2200 .Help Menu
:p.
...
:h1 id=2250  res=2250 .System Menu Additions
:i1 id=2250 .System Menu Additions
:p.
In the system menu you find the following additions:
:dl break=all tsize=3.

:dt.:hp2.Reduce / Enlarge Dot Size:ehp2.
:i2 refid=2250  sortkey=a.Reduce / Enlarge Dot Size
:i1 id=2250 .Reduce / Enlarge Dot Size
:dd.With this option you can affect the dots&apos. sizes when the
program is :link reftype=hd res=2503 .minimized to the desktop:elink..
...
:i2 refid=2250  sortkey=b.Show / Hide Icon Frame
:i1 id=2250 .Show / Hide Icon Frame
...
:h1 id=2350  res=2350 .Keys and Buttons Help
:i1 id=2350 .Keys and Buttons Help
:p.
...
:dd.When "Read Numbers" is checked in the Options menu or in the popup
menu and when you have MMPM installed, you can click on a number of
Crazy Clock&apos.s display, and Crazy Clock will tell you what this number
stands for.
